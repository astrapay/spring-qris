...
public interface MerchantCategoryCodes {
     ...
     */
    enum MerchantCategoryRange implements ITaxonomy {
         ...
         */
        MerchantCategoryRange(int start, int end, String description) {
        ...
        public static MerchantCategoryRange valueOf(int code) throws IllegalArgumentException {
            ...
            for (MerchantCategoryRange category : values()) {
                if (code >= category.startRange && code <= category.endRange) {
                    schemeCategory = category;
                    break;
                }
            }
            if (schemeCategory == null)
                throw new IllegalArgumentException("Invalid code (" + code + "): outside of allocated ranges"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    enum MastercardMerchantCategory implements ITaxonomy {
         ...
         */
        MastercardMerchantCategory(String description) {
            this.description = description;
        }
     ...
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory AIRLINES = MastercardMerchantCategory.AIRLINES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory AMUSEMENT_AND_ENTERTAINMENT = MastercardMerchantCategory.AMUSEMENT_AND_ENTERTAINMENT;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory AUTOMOBILE_VEHICLE_RENTAL = MastercardMerchantCategory.AUTOMOBILE_VEHICLE_RENTAL;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory AUTOMOBILES_AND_VEHICLES = MastercardMerchantCategory.AUTOMOBILES_AND_VEHICLES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory BUSINESS_SERVICES = MastercardMerchantCategory.BUSINESS_SERVICES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory CLOTHING_STORES = MastercardMerchantCategory.CLOTHING_STORES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory CONTRACTED_SERVICES = MastercardMerchantCategory.CONTRACTED_SERVICES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory GOVERNMENT_SERVICES = MastercardMerchantCategory.GOVERNMENT_SERVICES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory HOTELS_MOTELS = MastercardMerchantCategory.HOTELS_MOTELS;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory MOTO = MastercardMerchantCategory.MOTO;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory MISCELLANEOUS_STORES = MastercardMerchantCategory.MISCELLANEOUS_STORES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory PERSONAL_SERVICES_PROVIDERS = MastercardMerchantCategory.PERSONAL_SERVICE_PROVIDERS;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory PROFESSIONAL_SERVICES = MastercardMerchantCategory.PROFESSIONAL_SERVICES_AND_MEMBERSHIP;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory MEMBERSHIP_ORGANIZATIONS = MastercardMerchantCategory.PROFESSIONAL_SERVICES_AND_MEMBERSHIP;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory REPAIR_SERVICES = MastercardMerchantCategory.REPAIR_SERVICES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory RETAIL_STORES = MastercardMerchantCategory.RETAIL_STORES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory SERVICE_PROVIDERS = MastercardMerchantCategory.SERVICE_PROVIDERS;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory TRANSPORTATION = MastercardMerchantCategory.TRANSPORTATION;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory MASTERCARD_UK = MastercardMerchantCategory.MASTERCARD_UK;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory UTILITIES = MastercardMerchantCategory.UTILITIES;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory WHOLESALE = MastercardMerchantCategory.WHOLESALE;
    /**
     * MastercardMerchantCategory
     */
    MastercardMerchantCategory VISA_SERVICES = MastercardMerchantCategory.VISA_SERVICES;

    /**
     * Visa Merchant Category Group codes (expense types)
     */
    enum VisaMerchantCategoryGroup {
        /**
         * As TRBC
         */
        ...
        VisaMerchantCategoryGroup(int code, String label) {
            this.code = code;
            this.label = label;
        }
    ...
    // Shorthands
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_1_TRA = VisaMerchantCategoryGroup.MCG_1_COMMERCIAL_TRAVEL_AIRLINES;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_2_HOT = VisaMerchantCategoryGroup.MCG_2_LODGING;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_3_AUT = VisaMerchantCategoryGroup.MCG_3_AUTO_RENTAL;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_4_RES = VisaMerchantCategoryGroup.MCG_4_RESTAURANT;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_5_MEC = VisaMerchantCategoryGroup.MCG_5_MOTO_EC;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_6_RSK = VisaMerchantCategoryGroup.MCG_6_RISKY_PURCHASE;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_7_OTH = VisaMerchantCategoryGroup.MCG_7_OTHER;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_8_CSH = VisaMerchantCategoryGroup.MCG_8_OTHER_MANUAL_CASH;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_9_ATM = VisaMerchantCategoryGroup.MCG_9_ATM;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_10_QUA = VisaMerchantCategoryGroup.MCG_10_QUASI_CASH;
    /**
     * VisaMerchantCategoryGroup
     */
    VisaMerchantCategoryGroup MCG_11_MED = VisaMerchantCategoryGroup.MCG_11_MEDICAL;

    /**
     * Mastercard Transaction Category Codes
     */
    enum MastercardTransactionCategoryCode {
        /**
         * Mastercard Transaction Category Codes
         */
        ...
        MastercardTransactionCategoryCode(char code, String label) {
            this.code = code;
            this.label = label;
        }
    ...
    // Shorthands
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_A_CAR = MastercardTransactionCategoryCode.TCC_A_AUTOMOBILE_VEHICLE_RENTAL;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_C_CSH = MastercardTransactionCategoryCode.TCC_C_CASH_DISBURSEMENT;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_Z_ATM = MastercardTransactionCategoryCode.TCC_Z_CASH_DISBURSEMENT_ATM;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_F_RES = MastercardTransactionCategoryCode.TCC_F_RESTAURANT;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_H_HOT = MastercardTransactionCategoryCode.TCC_H_HOTEL_MOTEL;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_O_SCH = MastercardTransactionCategoryCode.TCC_O_COLLEGE_SCHOOL_EXPENSE;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_O_HOS = MastercardTransactionCategoryCode.TCC_O_HOSPITAL;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_P_TRX = MastercardTransactionCategoryCode.TCC_P_PAYMENT_TRANSACTION;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_R_OTH = MastercardTransactionCategoryCode.TCC_R_ALL_OTHER_MERCHANTS;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_T_OTH = MastercardTransactionCategoryCode.TCC_T_ALL_OTHER_NON_F2F_TRANSACTION;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_U_QEC = MastercardTransactionCategoryCode.TCC_U_UNIQUE_TRANSACTION_QUASI_CASH_DISBURSEMENT;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_U_OTH = MastercardTransactionCategoryCode.TCC_U_OTHER;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_R_CAT = MastercardTransactionCategoryCode.TCC_R_CARDHOLDER_ACTIVATED_TERMINAL_OTHER;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_X_AIR = MastercardTransactionCategoryCode.TCC_X_AIRLINES;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_X_RLW = MastercardTransactionCategoryCode.TCC_X_RAILROAD;
    /**
     * MastercardTransactionCategoryCode
     */
    MastercardTransactionCategoryCode TCC_X_TRA = MastercardTransactionCategoryCode.TCC_X_TRAVEL_AGENCY_TRANSPORTATION;
     ...
     */
    enum TRBCEconomicSector implements ITaxonomy {
         ...
         */
        TRBCEconomicSector(int code, String description) {
            this.code = code;
            this.description = description;
        }
     ...
     */
    enum TRBCBusinessSector implements ITaxonomy {
         ...
         */
        private final TRBCEconomicSector economicSector;
        /**
         ...
         */
        TRBCBusinessSector(int code, TRBCEconomicSector economicSector, String description) {
            this.code = code;
     ...
     */
    enum TRBCIndustryGroup implements ITaxonomy {
         ...
         */
        private final TRBCBusinessSector businessSector;
        /**
         * The last 2 digits of the TRBC code, rebuilt when invoking {@link #getCode()}
         */
        private final int code;
         ...
         */
        TRBCIndustryGroup(int code, TRBCBusinessSector businessSector, String description) {
            this.code = code;
     ...
     */
    enum TRBCIndustry implements ITaxonomy {
         ...
         */
        private final TRBCIndustryGroup industryGroup;
        /**
         * The last 2 digits of the TRBC code, rebuilt when invoking {@link #getCode()}
         */
        private final int code;
         ...
         */
        TRBCIndustry(int code, TRBCIndustryGroup industryGroup, String description) {
            this.code = code;
     ...
     */
    enum Iso18245MerchantCategoryCode {
         ...
         */
        private final MerchantCategoryRange categoryRange;
        /**
         * The Visa Merchant Category Group related to this MCC
         */
        private final VisaMerchantCategoryGroup schemeMCG;
        /**
         * The Mastercard Transaction Category Code related to this MCC
         */
        private final MastercardTransactionCategoryCode schemeTCC;
        /**
         * The (Mastercard) classification in head category for this MCC
         */
        private final MastercardMerchantCategory headCategory;
        /**
         * The Thomson Reuters Business Classification for this MCC
         */
        private final TRBCIndustry trbClassification;
         ...
         * @param trbClassification the Thomson Reuters Business Classification Industry category for this MCC
         ...
         */
        Iso18245MerchantCategoryCode(int code, MastercardMerchantCategory headCategory, TRBCIndustry trbClassification,
         ...
         * @return Iso18245MerchantCategoryCode
        ...
        public static Iso18245MerchantCategoryCode valueOf(int code) throws IllegalArgumentException {
            ...
            for (Iso18245MerchantCategoryCode mcc : values())
                if (mcc.getCode() == code) {
         ...
         * @return MerchantCategoryRange
         */
        public MerchantCategoryRange getCategoryRange() {
         ...
         *
         * @return VisaMerchantCategoryGroup
         */
        public VisaMerchantCategoryGroup getSchemeMCG() {
            return schemeMCG;
        }
         ...
         *
         * @return MastercardTransactionCategoryCode
         */
        public MastercardTransactionCategoryCode getSchemeTCC() {
            return schemeTCC;
        }
         ...
         *
         * @return MastercardMerchantCategory
         */
        public MastercardMerchantCategory getHeadCategory() {
            return headCategory;
        }
         ...
         * @return TRBCIndustry
         */
        public TRBCIndustry getTRBCClassification() {
            return trbClassification;
        }
        ...
        @Override
        public String toString() {
            return "MCC (" + getCodeAsString() + "): " + getDescription() + //$NON-NLS-1$ //$NON-NLS-2$
                    ...
                    "\n  Thomson Reuters Classification       = " + getTRBCClassification();
        }
         ...
         */
        public static class MerchantCategoryList implements Serializable, ITaxonomyList {
             ...
             */
            public MerchantCategoryList(int code) {
                this.code = code;
            }
        ...
        private interface ICategory extends ITaxonomyList {
             ...
             * @param mcc      mcc
             */
            void addMCC(ITaxonomy taxonomy, Iso18245MerchantCategoryCode mcc);

            /**
             * @param criterion criterion
             */
            void sortList(Comparator<MerchantCategoryCode> criterion);

            MerchantCategoryList getCategoryList();
        }

        /**
         * List of MCCs for a specific category (scheme or TRBC).
         */
        private class Category extends ArrayList<MerchantCategoryCode> implements ICategory {
            ...
            /**
             * Sorts this list with specified Merchant Category Code sorting <code>criterion</code> using {@link java.util.Collections}.
             *
             * @param criterion criterion
             */
            @Override
            ...
            public MerchantCategoryList getCategoryList() {
                return new MerchantCategoryList(code);
            }
